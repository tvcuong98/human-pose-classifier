...
# this is of test file
# Minimum x-coordinate: 21.30722891566266
# Maximum x-coordinate: 98.0276073619632
# Minimum y-coordinate: 1.8834196891191368
# Maximum y-coordinate: 145.9970313825276

# Define your custom operation
def evaluation_GAN_sample_soft(cuda_batch_tensor,batch_label,classi_model):
...
#GAN_model="/ske/Kinetic-GAN/runs/kinetic-gan/models/generator_175950.pth"
#GAN_model="/ske/Kinetic-GAN/runs/kinetic-gan-finetune/models/generator_102960.pth"
...
def sample_action(class_i,batch_size):
    ...
    matching_indexes_list1=list(evaluation_GAN_sample_soft(torch_flatten,labels,classi_model))
    matching_indexes_set1 = set(matching_indexes_list1)
    #print(matching_indexes_set1)
    ...
    #print(matching_indexes_combined)
