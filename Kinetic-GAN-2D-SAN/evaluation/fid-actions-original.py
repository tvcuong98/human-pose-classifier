...
def calculate_activation_statistics(path, labels, model, batch_size=50, dims=2048, # output the mean and the covariance matrix of the activations
...
def compute_statistics_of_path(path, labels, model, batch_size, dims, device, norm=True): # still output # output the mean and the covariance matrix of the activations
...
def calculate_fid_given_paths(paths, batch_size, device, dims): # give this 2 path of the real skeleton graph and the fake skeleton graph, along with their labels
